...
model_frame = load_pickle("../results/reduced_smcabc_res/simulation_skeleton.pkl")
model_frame.set_index(["simulation"], inplace=True)
...
dump_pickle(combined_df, "../results/reduced_smcabc_res/combined_particle_df.pkl")
pca_ordination = perform_pca_on_parameters(combined_df)
dump_pickle(pca_ordination,"../results/reduced_smcabc_res/pca_full_ordination.pkl")
