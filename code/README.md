...
* `toy_example.py` - Script for running the toy example which compares the Bayesian calculation method and the evolutionary algorithm. Output: `../results/toy_example/bayesian_{simulation}.pkl` and `../results/toy_example/crowdingDE_{simulation}.pkl`
...
* `visualization_for_manuscript.ipynb` - A Jupyter notebook used for visualizing the results. Due to the bulk of the work offloaded to the other scripts this notebook should be light enough to use on any laptop or desktop computer. Requires: `../results/toy_example/bayesian_{simulation}.pkl`, `../results/toy_example/crowdingDE_{simulation}.pkl`, `../results/permuted_smcabc_res/combined_df_metadata.pkl`, `../results/reduced_smcabc_res/combined_df_metadata.pkl`, `../results/pca.pkl`, `../results/permuted_smcabc_res/distance_frame.pkl`, `../results/reduced_smcabc_res/distance_frame.pkl`, `../results/crowdingDE/distance_frame.pkl`, `../results/aggregated_fva_res.pkl`, `../results/crowdingDE/evo_aggregated_fva_res.pkl`, ``../results/permuted_smcabc_res/pca_full_ordination.pkl`,`../results/reduced_aggregated_fva_res.pkl`, `../results/reduced_smcabc_res/pca_full_ordination.pkl`, `../results/permuted_smcabc_res/pca_reduced_ordination.pkl`, `../results/crowdingDE/evo_combined_df.pkl`, `../results/crowdingDE/evo_combined_df.pkl`, `../results/crowdingDE/evo_fva.pkl`, and `../results/crowdingDE/evo_pca.pkl`. Output: All plots used in the publication.
