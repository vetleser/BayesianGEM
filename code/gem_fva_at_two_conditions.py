...
full_simulation_skeleton: pd.DataFrame = pickle.load(open("../results/reduced_smcabc_res/simulation_skeleton.pkl",'rb'))
reduced_simulation_skeleton = full_simulation_skeleton.loc[:, ["simulation","outfile"]]
...
fva_frame = (reduced_simulation_skeleton[["simulation", "sampled_particles"]].
...
pickle.dump(obj=fva_frame, file=open("../results/reduced_smcabc_res/fva_at_two_conditions.pkl",'wb'))
logging.info("DONE")
